 ...
 */
@PublicEvolving
public class MyFlinkKafkaConsumer<T> extends MyFlinkKafkaConsumerBase<T> {
     ...
     * MyFlinkKafkaConsumer#KEY_PARTITION_DISCOVERY_INTERVAL_MILLIS} in the properties), topics with
