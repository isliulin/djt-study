 ...
 */
@Internal
public abstract class MyFlinkKafkaConsumerBase<T> extends RichParallelSourceFunction<T>
        implements CheckpointListener, ResultTypeQueryable<T>, CheckpointedFunction {

    private static final long serialVersionUID = -6272159445203409112L;

    protected static final Logger LOG = LoggerFactory.getLogger(MyFlinkKafkaConsumerBase.class);
     ...
     * MyFlinkKafkaConsumerBase#open(Configuration)} since it depends on whether or not checkpointing
     ...
     */
    public MyFlinkKafkaConsumerBase(
            List<String> topics,
     ...
     */
    public MyFlinkKafkaConsumerBase<T> assignTimestampsAndWatermarks(
     ...
     * @return The consumer object, to allow function chaining.
     */
    public MyFlinkKafkaConsumerBase<T> setCommitOffsetsOnCheckpoints(boolean commitOnCheckpoints) {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public MyFlinkKafkaConsumerBase<T> setStartFromEarliest() {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public MyFlinkKafkaConsumerBase<T> setStartFromLatest() {
     ...
     * @return The consumer object, to allow function chaining.
     */
    public MyFlinkKafkaConsumerBase<T> setStartFromTimestamp(long startupOffsetsTimestamp) {
        checkArgument(
     ...
     * @return The consumer object, to allow function chaining.
     */
    public MyFlinkKafkaConsumerBase<T> setStartFromGroupOffsets() {
     ...
     * MyFlinkKafkaConsumerBase#setStartFromGroupOffsets()}) for that particular partition.
     *
     ...
     * @return The consumer object, to allow function chaining.
     */
    public MyFlinkKafkaConsumerBase<T> setStartFromSpecificOffsets(
     ...
     * @return The consumer object, to allow function chaining.
     */
    public MyFlinkKafkaConsumerBase<T> disableFilterRestoredPartitionsWithSubscribedTopics() {
